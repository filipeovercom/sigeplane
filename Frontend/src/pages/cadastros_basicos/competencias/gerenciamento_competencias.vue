  ...
  <q-page padding class="docs-table">
    ...
    <q-card>
      <q-card-main class="q-pa-none">
        <q-table ref="table" color="primary" :data="competencias" :columns="dataTable.columns"
          ...
          <template slot="top-right" slot-scope="props">
            ...
            <q-btn push class="q-mr-sm" color="secondary" round icon="edit" title="Editar Competência"
